...
app.post('/register',(req,res) => {
    ...
    console.log(registerName, registerSurname, registerEmail, hash);  // registerPassword

    const sqlRegister = "INSERT INTO customer(name, surname, email, password) VALUES (?,?,?,?)" // password
