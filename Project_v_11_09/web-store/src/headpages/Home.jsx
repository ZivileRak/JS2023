...
<div>
         ...
         <body> 
            <p>Having a spa at home has many advantages for those who decide to build one. 
                Not only obvious benefits for health and beauty, but also for the comfort and well-being it brings to your home.</p>
         ...
         <span className="span"> "Please review the product list" <Link to ="/product">SPA equitment</Link> </span>
